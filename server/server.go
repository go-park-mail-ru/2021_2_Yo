...
func newRouterWithEndpoints(app *App) *mux.Router {
	...
	r.HandleFunc("/events", app.eventManager.GetEvents).Queries("query", "{query}", "category", "{category}", "tag", "{tag}").Methods("GET")
	r.HandleFunc("/events", app.eventManager.GetEvents).Queries("query", "{query}", "category", "{category}").Methods("GET")
	r.HandleFunc("/events", app.eventManager.GetEvents).Queries("query", "{query}", "tag", "{tag}").Methods("GET")
	r.HandleFunc("/events", app.eventManager.GetEvents).Queries("query", "{query}").Methods("GET")
	r.HandleFunc("/events", app.eventManager.GetEvents).Queries("category", "{category}", "tag", "{tag}").Methods("GET")
	r.HandleFunc("/events", app.eventManager.GetEvents).Queries("category", "{category}").Methods("GET")
	r.HandleFunc("/events", app.eventManager.GetEvents).Queries("tag", "{tag}").Methods("GET")
